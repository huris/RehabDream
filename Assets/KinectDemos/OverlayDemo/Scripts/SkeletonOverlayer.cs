        ...
        if (WaitFrame == ChangeBallWaitFrame)
        {
            ...
            switch (NowSoccerIndex)
            {
                case 0:
                    ...
                    break;
                case 1:
                    ShowTips("保持Bobath握拳，朝右上方小球移动");
                    break;
                case 2:
                    ShowTips("保持Bobath握拳，朝左上方小球移动");
                    break;
                case 3:
                    ShowTips("保持Bobath握拳，朝正右方小球移动");
                    break;
                case 4:
                    ShowTips("保持Bobath握拳，朝正左方小球移动");
                    break;
                case 5:
                    ShowTips("保持Bobath握拳，朝右下方小球移动");
                    break;
                case 6:
                    ShowTips("保持Bobath握拳，朝左下方小球移动");
                    break;
                case 7:
                    ShowTips("保持Bobath握拳，朝正下方小球移动");
                    break;
                case 8:
                    ShowTips("保持Bobath握拳，朝前后方小球移动");
                    break;
            }
        }
