...
public class GameState : MonoBehaviour
{
    ...
    public void WriteDatabaseInGame()
    {
        ...
        SQLStringList.Add("INSERT INTO Angles VALUES(" + PatientDataManager.instance.TrainingID.ToString()
                            + "," + _Caculator.LeftArmAbductionAngle().ToString()
                            + "," + _Caculator.RightArmAbductionAngle().ToString()
                            + "," + _Caculator.LeftArmFlexionAngle().ToString()
                            + "," + _Caculator.RightFlexionAngle().ToString()
                            + "," + _Caculator.LeftElbowFlexionAngle().ToString()
                            + "," + _Caculator.RightElbowFlexionAngle().ToString()
                            + "," + _Caculator.LeftKneeFlexionAngle().ToString()
                            + "," + _Caculator.RightKneeFlexionAngle().ToString()
