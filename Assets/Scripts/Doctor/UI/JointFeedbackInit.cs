    ...
    public class JointFeedbackInit : MonoBehaviour
    {
        ...
        void OnEnable()
        {
            if (DoctorDataManager.instance.doctor.patient.TrainingPlays != null && DoctorDataManager.instance.doctor.patient.TrainingPlays.Count > 0)
            {
                ...
                AngleCount = DoctorDataManager.instance.doctor.patient.TrainingPlays[DoctorDataManager.instance.doctor.patient.TrainingPlayIndex].angles.Count;
                ...
                for (int i = 0; i < AngleCount; i++)
                {
                    ...
                    LeftRightChart.AddData(0, DoctorDataManager.instance.doctor.patient.TrainingPlays[DoctorDataManager.instance.doctor.patient.TrainingPlayIndex].angles[i].LeftSideAngle);
                    LeftRightChart.AddData(1, DoctorDataManager.instance.doctor.patient.TrainingPlays[DoctorDataManager.instance.doctor.patient.TrainingPlayIndex].angles[i].RightSideAngle);

                    UponDownChart.AddXAxisData((i * 0.2f).ToString("0.0"));
                    UponDownChart.AddData(0, DoctorDataManager.instance.doctor.patient.TrainingPlays[DoctorDataManager.instance.doctor.patient.TrainingPlayIndex].angles[i].UponSideAngle);
                    UponDownChart.AddData(1, DoctorDataManager.instance.doctor.patient.TrainingPlays[DoctorDataManager.instance.doctor.patient.TrainingPlayIndex].angles[i].DownSideAngle);

                    ArmChart.AddXAxisData((i * 0.2f).ToString("0.0"));
                    ArmChart.AddData(0, DoctorDataManager.instance.doctor.patient.TrainingPlays[DoctorDataManager.instance.doctor.patient.TrainingPlayIndex].angles[i].LeftArmAngle);
                    ArmChart.AddData(1, DoctorDataManager.instance.doctor.patient.TrainingPlays[DoctorDataManager.instance.doctor.patient.TrainingPlayIndex].angles[i].RightArmAngle);

                    ElbowChart.AddXAxisData((i * 0.2f).ToString("0.0"));
                    ElbowChart.AddData(0, DoctorDataManager.instance.doctor.patient.TrainingPlays[DoctorDataManager.instance.doctor.patient.TrainingPlayIndex].angles[i].LeftElbowAngle);
                    ElbowChart.AddData(1, DoctorDataManager.instance.doctor.patient.TrainingPlays[DoctorDataManager.instance.doctor.patient.TrainingPlayIndex].angles[i].RightElbowAngle);

                    LegChart.AddXAxisData((i * 0.2f).ToString("0.0"));
                    LegChart.AddData(0, DoctorDataManager.instance.doctor.patient.TrainingPlays[DoctorDataManager.instance.doctor.patient.TrainingPlayIndex].angles[i].LeftLegAngle);
                    LegChart.AddData(1, DoctorDataManager.instance.doctor.patient.TrainingPlays[DoctorDataManager.instance.doctor.patient.TrainingPlayIndex].angles[i].RightLegAngle);

                    HipChart.AddXAxisData((i * 0.2f).ToString("0.0"));
                    HipChart.AddData(0, DoctorDataManager.instance.doctor.patient.TrainingPlays[DoctorDataManager.instance.doctor.patient.TrainingPlayIndex].angles[i].LeftHipAngle);
                    HipChart.AddData(1, DoctorDataManager.instance.doctor.patient.TrainingPlays[DoctorDataManager.instance.doctor.patient.TrainingPlayIndex].angles[i].RightHipAngle);
                    HipChart.AddData(2, DoctorDataManager.instance.doctor.patient.TrainingPlays[DoctorDataManager.instance.doctor.patient.TrainingPlayIndex].angles[i].HipAngle);

                    KneeChart.AddXAxisData((i * 0.2f).ToString("0.0"));
                    KneeChart.AddData(0, DoctorDataManager.instance.doctor.patient.TrainingPlays[DoctorDataManager.instance.doctor.patient.TrainingPlayIndex].angles[i].LeftKneeAngle);
                    KneeChart.AddData(1, DoctorDataManager.instance.doctor.patient.TrainingPlays[DoctorDataManager.instance.doctor.patient.TrainingPlayIndex].angles[i].RightKneeAngle);
                    ...
                    AnkleChart.AddData(0, DoctorDataManager.instance.doctor.patient.TrainingPlays[DoctorDataManager.instance.doctor.patient.TrainingPlayIndex].angles[i].LeftAnkleAngle);
                    AnkleChart.AddData(1, DoctorDataManager.instance.doctor.patient.TrainingPlays[DoctorDataManager.instance.doctor.patient.TrainingPlayIndex].angles[i].RightAnkleAngle);
                }
            }
