...
public class DoctorDatabaseManager : MonoBehaviour
{
        ...
        if (!this.PatientDatabase.IsTableExists(EvaluationSoccerTableName))  //check PatientInfoTableName table
        {
            this.PatientDatabase.CreateTable(
                ...
                new String[] {
                    ...
                    "UponSoccerScore",
                    "UponRightSoccerScore",
                    "RightSoccerScore",
                    "DownRightSoccerScore",
                    "DownSoccerScore",
                    "DownLeftSoccerScore",
                    "LeftSoccerScore",
                    "UponLeftSoccerScore",
    ...
    public List<Evaluation> ReadPatientEvaluations(long PatientID)
    {
        ...
        string QueryString = "SELECT * FROM PatientEvaluation where PatientID=" + PatientID.ToString() + " order by EvaluationEndTime";
    ...
    public SoccerDistance ReadEvaluationSoccerDistanceRecord(long EvaluationID)
    {
        ...
        try
        {
            ...
            if (reader.HasRows)
            {
                ...
                reader.GetInt64(reader.GetOrdinal("UponSoccerScore")),
                reader.GetInt64(reader.GetOrdinal("UponRightSoccerScore")),
                reader.GetInt64(reader.GetOrdinal("RightSoccerScore")),
                reader.GetInt64(reader.GetOrdinal("DownRightSoccerScore")),
                reader.GetInt64(reader.GetOrdinal("DownSoccerScore")),
                reader.GetInt64(reader.GetOrdinal("DownLeftSoccerScore")),
                reader.GetInt64(reader.GetOrdinal("LeftSoccerScore")),
                reader.GetInt64(reader.GetOrdinal("UponLeftSoccerScore")),
                reader.GetInt64(reader.GetOrdinal("FrontSoccerScore")),
                reader.GetInt64(reader.GetOrdinal("BehindSoccerScore")),
